//! CRC-8 implementation for tspack
//!
...
mod tests {
    ...
    #[test]
    fn test_crc8_multiple_bytes() {
        // Known test vector
        assert_eq!(crc8(&[0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39]), 0xF4);
    }

    #[test]
    fn test_crc8_detects_corruption() {
        let data = [0xA0, 0x01, 0x12, 0x34, 0x56, 0x78];
        let crc = crc8(&data);
